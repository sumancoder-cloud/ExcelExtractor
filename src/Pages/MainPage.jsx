    ...
    return ( 
        ...
        <div className=" flex bg-orange-500 w-full h-[80px] justify-between items-center shadow-lg top-0 left-0 fixed z-50">
            ...
            <div className="flex justify-center items-center">
                <ul className="hidden md:flex gap-5 font-semibold text-white m-4">
                ...
                <div className="m-4 md:hidden">
                  <FaHamburger className="text-white text-3xl cursor-pointer " onClick={()=>setShowMenu(!showMenu)}/>
              </div>
            </div>
        ...
        {/* Mobile Menu Card */}
{showMenu && (
  <div className="fixed top-20 right-4 bg-white w-[200px] h-[200px] rounded-lg shadow-lg z-50 md:hidden p-5">
    <div className="flex flex-col gap-5 ">
        <ul className="flex flex-col gap-5 justify-center items-center">
            <li className="cursor-pointer border-2 w-full px-5 py-2 hover:bg-gray-400 hover:text-white">Features</li>
            <li className="cursor-pointer border-2 w-full px-5 py-2 hover:bg-gray-400 hover:text-white">PDF To Excel</li>
            <li className="cursor-pointer border-2 w-full px-5 py-2 hover:bg-gray-400 hover:text-white">Image To Excel</li>
